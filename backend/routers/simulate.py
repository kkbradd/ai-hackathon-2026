...
VALID_EVENTS = {"delayed_shipment", "stock_drop", "complaint", "anomaly", "delivery", "new_order", "new_customer", "restock_critical", "spread_pipeline"}
...
def trigger_event(
    ...
    labels = {
        ...
        "restock_critical": "Kritik stoklar yeniden dolduruldu.",
        "spread_pipeline":  "Kargolar pipeline'da dağıtıldı.",
    }
